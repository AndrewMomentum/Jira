                ...
                <div class="col-md-6 col-lg-4">
                    <div class="product-content">
                        ...
                        <div class="mt-2 link-inherit fs-xs">
                            <p><strong class="text-title me-3 font-theme">التوفر :</strong><a href="#"><i class="far fa-check-square me-2 ms-1"></i>مخزون معد للبيع
</a></p>
                        </div>
                        <div class="actions mb-4 pb-2">
                            ...
                            <button class="vs-btn shadow-none" id="add_cart">أضف إلى السلة</button>
                        </div>
                        <div class="product_meta">
                            <span class="posted_in">فئات: <a href="#" rel="tag" id="proudect_category"></a></span>
                        </div>
                    </div>
                </div>
