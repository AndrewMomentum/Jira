                    ...
                    <div class="tab-content" id="myTabContent">
                        ...
                        <div class="form-row w-100" style="margin:0; display: block;">
                            ...
                            <div class="form-group col-11 col-lg-8 col-md-10 col-sm-8">
                                <input name="name" type="text" class="form-control"  placeholder="الاسم" id="name">
                                <p class="errorinput name-error"></p>
                            </div>
                            <div class="form-group col-11 col-lg-8 col-md-10 col-sm-8">
                                <input name="email" type="text" class="form-control" placeholder="البريد الالكتروني" id="email">
                                <p class="errorinput email-error"></p>
                            </div>
                            <div class="form-group col-11 col-lg-8 col-md-10 col-sm-8">
                                <input name="phone" type="text" class="form-control" placeholder="الهاتف" id="phone" disabled>
                            </div>
                            <div class="form-group  col-5">
                            </div>
                            <div class="col-11 col-lg-5 col-md-10 col-sm-8">
                                <button type="submit" class="btn mt-5 mb-5 btn qut-btn vs-btn shadow-none"
                                style="background-color: #5abb45;"> تحديث</button>
                            </div>
                        </div>
